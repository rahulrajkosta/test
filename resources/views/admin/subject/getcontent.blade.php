...
<div class="row">
  <div class="col-12">
    <div class="page-title-box d-flex align-items-center justify-content-between">
      <h4 class="mb-0">All Contents List ({{$subject->subject_name ?? ''}})</h4>
                            ...
                            <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-danger btn-sm" href="{{ route($routeName.'.subject.delete_content', $video->id.'?back_url='.$BackUrl) }}"><i class="fa fa-trash"></i>
                                            </a>
                                        </td>
                            ...
                            <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-danger btn-sm" href="{{ route($routeName.'.subject.delete_content', $note->id.'?back_url='.$BackUrl) }}"><i class="fa fa-trash"></i>
                                            </a>
                                        </td>
