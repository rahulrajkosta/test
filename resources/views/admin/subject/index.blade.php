               ...
               <?php } ?>
                  ...
                  <td>
                      ...
                      $htmls = '';
                          ...
                          $htmls.='<a title="Edit" class="btn btn-primary btn-sm" href="' . route($routeName.'.subject.edit',$b->id.'?back_url='.$BackUrl) . '"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;&nbsp;<a title="Delete" class="btn btn-danger btn-sm" href="' . route($routeName.'.subject.delete',$b->id.'?back_url='.$BackUrl) . '"><i class="fa fa-trash"></i></a>&nbsp;&nbsp;&nbsp;


                         ';
                        echo $htmls;

                         // <a title="Content" class="btn btn-info btn-sm" href="' . route($routeName.'.subject.getcontent',$b->id.'?back_url='.$BackUrl) . '">Content</a>
