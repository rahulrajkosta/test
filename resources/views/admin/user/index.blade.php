                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h2 class="card-title">Users - ({{ $users->total() }})</h2>
                            ...
                            <div class="heading-elements">
                                <ul class="list-inline mb-0">
                                    <li>
                                        ...
                                        &nbsp;&nbsp;&nbsp;
                                        <!-- <a href="{{ route($routeName . '.user.add', ['back_url' => $BackUrl]) }}" class="btn btn-info btn-sm" style='float: right;'>Add User</a> -->
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            foreach($roles as $role){
                              ...
                              ?>
                                                    <!-- <input type="hidden" name="key{{ $role->id }}" value="{{ $j }}">
                                                    ...
                                                    <div class="col-4 mt-3">
                                                        ...
                                                        <div class="input-group">
                                                            <select class="form-control select2"
                                                                name="{{ $role->slug . '_id' }}"
                                                                id="role{{ $role->slug }}"
                                                                onchange="get_childs(this.value,'{{ $child_role->slug ?? '' }}')">
                                      ...
                                      $j--;
                                        ...
                                        if(!empty($states)){
                                          foreach($states as $state){?>
                                                            <option value="{{ $state->id ?? '' }}" <?php if ($state_id == $state->id) {
                                                                echo 'selected';
                                                            } ?>>
                                                                {{ $state->name ?? '' }}</option>
                                                            <?php }
                                        ...
                                        if(!empty($cities)){
                                          foreach($cities as $city){?>
                                                            <option value="{{ $city->id ?? '' }}" <?php if ($city_id == $city->id) {
                                                                echo 'selected';
                                                            } ?>>
                                                                {{ $city->name ?? '' }}</option>
                                                            <?php }
                                                    ...
                                                    <div class="col-6 mt-3">
                                                        ...
                                                        <div class="input-group">
                                                            <select class="form-control" name="phone_status">
                                                                <option value="" selected>Select Phone Status
                                                                </option>
                                                                <option value="locked" <?php if ($phone_status == 'locked') {
                                                                    echo 'selected';
                                                                } ?>>Locked
                                                                </option>
                                                                <option value="unlock" <?php if ($phone_status == 'unlock') {
                                                                    echo 'selected';
                                                                } ?>>Unlock
                                                                </option>
                                                                <option value="remove" <?php if ($phone_status == 'remove') {
                                                                    echo 'selected';
                                                                } ?>>Remove
                                                                </option>
                                                            </select>
                        ...
                        <div class="card-content collapse show">
                            <div class="table-responsive">
                              ...
                              ?>
                                        <tr>
                                            <td>{{ $user->user_id }}</td>
                                            <td>Name : {{ $user->user_name ?? '' }}<br>Phone : {{ $user->user_phone ?? '' }} <br>Address: {{ $user->address ?? '' }}
                                                <!-- <img src="{{ url('public/storage/user/' . $user->user_image) }}" style="height:70px;width:70px"></td> -->

                                                <a target="_blank" href="{{ $image }}"><img
                                                        src="{{ $image }}" style="height:70px;width:70px"></a>
                                                ...
                                                <p>ScreenShot</p>
                                                <a href="{{ url('public/storage/screenshot/' . $user->screenshot) }}"
                                                    target="_blank"><img
                                                        src="{{ url('public/storage/screenshot/' . $user->screenshot) }}"
                                            ...
                                            <td>
                                                ...
                                                </strong>{{ $admin->business_name ?? '' }}<br><strong>Unique ID
                                                    :</strong> {{ $admin->unique_id ?? '' }}
                                                <br><strong>Coupon Code :</strong>
                                                {{ $user->coupon_code ?? '' }}<br><strong>Used At :
                                                </strong>{{ $user->date_of_purchase ?? '' }}
                                            </td>
                                            <td width="30%">
                                                <strong>Phone Model :
                                                </strong>{{ $user->phone_model ?? '' }}<br><strong>Mobile Name
                                                    :</strong> {{ $user->mobile_name ?? '' }}
                                                <br><strong>IMEI No :</strong>
                                                {{ $user->imei_no ?? '' }}<br><strong>Date Of Purchase :
                                                </strong>{{ $user->date_of_purchase ?? '' }}
                                                <br><span style="line-break:anywhere;"><strong>Device Token :
                                                    </strong>{{ $user->device_token ?? '' }}</span>

                                            </td>

                                            <td>
                                                <strong>Total Price :
                                                </strong>{{ $user->total_price ?? '' }}<br><strong>Down Payment
                                                    :</strong> {{ $user->downpayment ?? '' }}
                                                <br><strong>Emi :</strong> {{ $user->emi ?? '' }}<br><strong>Total
                                                    Months : </strong>{{ $user->total_months ?? '' }}<br><strong>Start
                                                    Date : </strong>{{ $user->start_date ?? '' }}

                                            </td>
                                            <td><strong>Latitute : </strong>{{ $user->latitute ?? '' }}
                                                <br><strong>Longitude : </strong>{{ $user->longitude ?? '' }}</td>
                                            <td>
                                                <h2>{{ ucfirst($user->phone_status) }}</h2>
                                                <br>
                                                <br>
                                                <?php if($user->phone_status == 'locked'){?>
                                                <a onclick="change_phone_status('{{ $user->user_id }}','unlock')"
                                                    class="btn btn-success">Unlock</a> &nbsp;&nbsp;
                                                <br>
                                                <br>
                                                <a href=""
                                                    onclick="change_phone_status('{{ $user->user_id }}','remove')"
                                                    class="btn btn-info">Remove</a> &nbsp;&nbsp;
                                                <?php }?>

                                                <?php if($user->phone_status == 'unlock'){?>
                                                <a onclick="change_phone_status('{{ $user->user_id }}','locked')"
                                                ...
                                                <!--  <select class="form-control" name="phone_status" id="change_phone_status{{ $user->user_id }}" onchange="change_phone_status({{ $user->user_id }});" style="width:auto;">
                                          <option value="" selected>Select Phone Status</option>
                                          <option value="locked" <?php //if($user->phone_status == 'locked'){ echo 'selected'; }
                                          ?>>Locked</option>
                                          <option value="unlock" <?php //if($user->phone_status == 'unlock'){ echo 'selected'; }
                                          ?>>Unlock</option>
                                          <option value="remove" <?php //if($user->phone_status == 'remove'){ echo 'selected'; }
                                          ?>>Remove</option>
                                        </select> -->
                                            </td>
                                            ...
                                            <td>
                                                <!-- <div class="d-flex">
                                 <a class="btn btn-warning" title="Transaction" href="{{ route($routeName . '.user.transaction', $user->id . '?back_url=' . $BackUrl) }}"><i class="fa fa-rupee"></i></a>&nbsp;&nbsp;&nbsp;
                                <a class="btn btn-info" title="User List" href="{{ route($routeName . '.user.user_list', $user->id . '?back_url=' . $BackUrl) }}"><i class="fa fa-user-circle"></i></a>
                               </div>
                               <br>
                                <div class="d-flex">
                                 <a class="btn btn-warning" title="Transaction" href="{{ route($routeName . '.user.transaction', $user->id . '?back_url=' . $BackUrl) }}"><i class="fa fa-rupee"></i></a>&nbsp;&nbsp;&nbsp;
...
<script>
    ...
    function get_childs(user_id, role_name) {
        var _token = '{{ csrf_token() }}';
        $.ajax({
            url: "{{ route($routeName . '.get_childs') }}",
            type: "POST",
            data: {
                user_id: user_id
            },
    ...
    function change_phone_status(id, phonestatus) {
        if (confirm('Are You Want To Sure To Change Status')) {
            var _token = '{{ csrf_token() }}';
            $.ajax({
                url: "{{ route($routeName . '.user.change_phone_status') }}",
                type: "POST",
                data: {
