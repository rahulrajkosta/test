            ...
            {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                <label for="userName">Option 1<span class="text-danger">*</span></label>
                                 ...
                                 <textarea class="form-control" id="option_1" name="option_1">
                                    {{ old('option_1', $option_1) }}
                                </textarea>
                            ...
                            <div class="form-group">
                                <label for="userName">Option 2<span class="text-danger">*</span></label>
                                 ...
                                 <textarea class="form-control" id="option_2" name="option_2">
                                    {{ old('option_2', $option_2) }}
                                </textarea>
                            ...
                            <div class="form-group">
                               ...
                               <textarea class="form-control" id="option_3" name="option_3">
                                    {{ old('option_3', $option_3) }}
                                </textarea>
                            ...
                            <div class="form-group">
                             ...
                             <textarea class="form-control" id="option_4" name="option_4">
                                    {{ old('option_4', $option_4) }}
                                </textarea>
