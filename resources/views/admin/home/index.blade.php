...
<div class="content-body">
        ...
        <div class="col-xl-3 col-lg-6 col-12">
            <div class="card bg-gradient-x-purple-blue">
                <div class="card-content">
                    <a href="{{ route($ADMIN_ROUTE_NAME.'.my_coupons.coupons_history') }}">
                        <div class="card-body" style="height:176px">
                            <div class="media d-flex">
                                ...
                                <div class="media-body text-white text-right align-self-bottom mt-3">
                                    ...
                                    <h1 class="text-white mb-0">{{$total_coupon ?? 0}}</h1>
                                </div>
                            </div>
                        </div>
                    </a>
    ...
    if(!empty($roles)){
        ...
        foreach($roles as $role){
            ...
            ?>
            <div class="col-xl-3 col-lg-6 col-12">
                <div class="{{$colorArr[$i-1]}}">
                    <div class="card-content">
                     <a href="{{ route($ADMIN_ROUTE_NAME.'.'.$role->slug.'.index',['fetch_role_id'=>$role->id,'user_id'=>$user_id,'key'=>$i]) }}">
                         <!-- <a href="#"> -->
                            <div class="card-body" style="height:176px">
                                <div class="media d-flex">
                                    <div class="align-self-top">
                                    ...
                                    <div class="media-body text-white text-right align-self-bottom mt-3">
                                        <span class="d-block mb-1 font-medium-1">Total {{$role->name ??''}}</span>
                                        <h1 class="text-white mb-0">{{$no_of_child??0}}</h1>
                                    </div>
                                </div>
                            </div>
                        </a>
        ...
        <div class="col-xl-3 col-lg-6 col-12">
            <div class="card bg-gradient-directional-success">
                <div class="card-content">
                    <a href="{{ route($ADMIN_ROUTE_NAME.'.user.index') }}">
                        <!-- <a href="#"> -->
                            <div class="card-body" style="height:176px">
                                <div class="media d-flex">
                                    <div class="align-self-top">
                                    ...
                                    <div class="media-body text-white text-right align-self-bottom mt-3">
                                        ...
                                        <h1 class="text-white mb-0">{{$total_users??0}}</h1>
                                    </div>
                                </div>
                            </div>
                        </a>
            ...
            <div class="col-xl-3 col-lg-6 col-12">
                <div class="card bg-gradient-x-purple-blue">
                    <div class="card-content">
                        <a href="{{ route($ADMIN_ROUTE_NAME.'.user.index',['date'=>date('Y-m-d')]) }}">
                            <!-- <a href="#"> -->
                                <div class="card-body" style="height:176px">
                                    <div class="media d-flex">
                                        <div class="align-self-top">
                                        ...
                                        <div class="media-body text-white text-right align-self-bottom mt-3">
                                            ...
                                            <h1 class="text-white mb-0">{{$today_users??0}}</h1>
                                        </div>
                                    </div>
                                </div>
                            </a>
                ...
                <?php if($role_id == 4){
                    ...
                    <div class="col-xl-3 col-lg-6 col-12">
                        <div class="card bg-gradient-x-purple-blue">
                            <div class="card-content">
                                <a href="{{ route($ADMIN_ROUTE_NAME.'.seller.add',['parent_id'=>'','back_url'=>$back_url]) }}">
                                    <!-- <a href="#"> -->
                                        <div class="card-body" style="height:176px">
                                            <div class="media d-flex">
                                                <div class="align-self-top">
                    ...
                    <?php if($role_id == 0){
                        ...
                        foreach($phonestatusArr as $key=>$phone){
                            ...
                            <div class="col-xl-3 col-lg-6 col-12">
                                <div class="{{$colorArr[$i-1]}}">
                                    <div class="card-content">
                                        <a href="{{ route($ADMIN_ROUTE_NAME.'.user.index',['phone_status'=>$phone]) }}">
                                            <!-- <a href="#"> -->
                                                <div class="card-body" style="height:176px">
                                                    <div class="media d-flex">
                                                        <div class="align-self-top">
                                                        ...
                                                        <div class="media-body text-white text-right align-self-bottom mt-3">
                                                            <span class="d-block mb-1 font-medium-1">{{ucfirst($phone)}} User</span>
                                                            <h1 class="text-white mb-0">{{$users_count??0}}</h1>
                                                        </div>
                                                    </div>
                                                </div>
                                            </a>
