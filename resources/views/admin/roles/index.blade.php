                ...
                <div class="heading-elements">
                  <ul class="list-inline mb-0">
                    <li>
                     ...
                     <!-- <a href="{{ route($ADMIN_ROUTE_NAME.'.roles.add').'?back_url='.$BackUrl }}" class="btn btn-info btn-sm" style='float: right;'>Add Roles</a> -->
                   </li>
                 </ul>
               </div>
            </div>
                  ...
                  <table class="table">
                    ...
                    foreach($roles as $role){
                      ...
                      <tr>
                        <td>{{$i++}}</td>
                          <td>{{$role->name??''}}</td>
                          <td>{{CustomHelper::getRoleName($role->parent_id)}}</td>
                        ...
                        <td>
                          ...
                          <!-- <a class="btn btn-success" href="{{ route($routeName.'.roles.edit', $role->id.'?back_url='.$BackUrl) }}"><i class="fa fa-edit"></i></a> -->
