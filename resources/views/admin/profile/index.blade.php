              ...
              <div class="card-body">
                <form class="card-body" action="" method="post" accept-chartset="UTF-8" enctype="multipart/form-data" role="form">
                  ...
                  <div class="col-md-12 ">
                    ...
                    <input type="text" class="form-control mb-3" name="business_name" id="exampleInputName"  value="{{Auth::guard('admin')->user()->business_name ?? ''}}" placeholder="Enter Business Name" aria-label="default input example">
                  </div>
                  ...
                  <div class="col-md-12 ">
                    ...
                    <input type="number" class="form-control mb-3" name="phone" id="exampleInputNumber"  value="{{Auth::guard('admin')->user()->phone ?? ''}}" placeholder="Enter Name" aria-label="default input example">
                  </div>
                  <div class="col-md-12 ">
                    <label for="fullname" class="form-label">Alt Contact No.</label>
                    <input type="number" class="form-control mb-3" name="alternate_phone" id="exampleInputNumber"  value="{{Auth::guard('admin')->user()->alternate_phone ?? ''}}" placeholder="Enter Name" aria-label="default input example">
                  </div>
                  ...
                  <div class="col-md-12 ">
                    ...
                    <input type="text" class="form-control mb-3" name="address" id="address"  value="{{ old('address',$address) }}" placeholder="Enter address" aria-label="default input example">
                  </div>
