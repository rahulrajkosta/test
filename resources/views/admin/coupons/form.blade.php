          ...
          <div class="col-md-12">
            <div class="card">
             ...
             <div class="card-content collapse show">
              <div class="card-body">
                <h1 style="color:red;">Last Coupon Serial No is {{$min??1}}</h1>
                <form class="card-body" action="" method="post" accept-chartset="UTF-8" enctype="multipart/form-data" role="form">
                  ...
                  <div class="col-md-4 mb-3">
                   ...
                   <input class="form-control mb-3" type="text" name="min_coupon" id="min_coupon"  value="{{old('min_coupon',$min)}}" disabled placeholder="No Of Coupons" aria-label="default input example">
                 </div>

                 <div class="col-md-4 mb-3">
                   <label for="fullname" class="form-label">No Of Coupons</label>
                   <input class="form-control mb-3" type="number" name="no_of_coupons" id="no_of_coupons"  value="{{old('no_of_coupons')}}" placeholder="No Of Coupons" aria-label="default input example">
                 </div>
                 <div class="col-md-4 mb-3">
                   <label for="fullname" class="form-label">Maximum coupon No</label>
                   <input class="form-control mb-3" type="text" name="max_coupon" id="max_coupon"  value="{{old('max_coupon')}}" disabled placeholder="No Of Coupons" aria-label="default input example">
                 </div>
