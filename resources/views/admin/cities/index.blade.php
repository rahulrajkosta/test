            ...
            <div class="card-header">
              ...
              <div class="heading-elements">
                <ul class="list-inline mb-0">
                  <li>
                    <a href="{{ route($routeName.'.cities.add', ['back_url' => $BackUrl]) }}" class="btn btn-info btn-sm" style='float: right;'>Create City</a>
                  </li>
                </ul>
              </div>
            </div>
                       ...
                       if(!empty($icon)){
                         if($storage->exists($path.$icon)){
                          ...
                          <div class=" image_box" style="display: inline-block">
                            <a href="{{ url('public/storage/'.$path.$icon) }}" target="_blank">
                              <img src="{{ url('public/storage/'.$path.'thumb/'.$icon) }}" style="width:70px;">
                            </a>
                          </div>
                          <?php
                        }
