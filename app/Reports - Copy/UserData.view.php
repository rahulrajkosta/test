...
<div class="content-wrapper-before"></div>
    <div class="content-header row">
      <div class="content-header-left col-md-4 col-12 mb-2">
        <h3 class="content-header-title">User Data report from <?=$this->dataStore("myData")->toArray()[0]['Dates'] ;?> to <?=$this->dataStore("myData")->toArray()[count($this->dataStore("myData")->toArray())-1]['Dates']; ?></h3>
      </div>
