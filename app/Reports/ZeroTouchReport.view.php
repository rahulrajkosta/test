...
.ttl .datatables .messageTop { font-size: 10px; text-align: center; font-family: 'Poppins sans-serif';position:absolute;left:0;top:-100 }
...
<div class="row">
  <div class="col-12">
    <div class="card">
      ...
      <h3 class="content-header-title text-dark">Zero Touch Details report 
        <h4><?php if(!empty($this->dataStore("zero_touch_data")->toArray())){echo "from ";
          $date=date_create($this->dataStore("zero_touch_data")->toArray()[0]['Dates']);
          echo date_format($date,"d-m-Y H:i:s A");?>
           to 
           <?php 
           $date=date_create($this->dataStore("zero_touch_data")->toArray()[count($this->dataStore("zero_touch_data")->toArray())-1]['Dates']);
           echo date_format($date,"d-m-Y H:i:s A");
           ; }?></h4></h3>
    ...
    margin: 0px auto;">
<?php
if(count($this->dataStore('zero_touch_data')->toArray())>0)
{
Table::create(array(
