...
Class TestSeriesController extends Controller
{
    ...
    public function index(Request $request){
     ...
     return view('admin.test_series.index',$data);
 }
...
public function add(Request $request){
    ...
    $subjects = Subject::where('course_id',$exams->course_id)->get();
    ...
    return view('admin.test_series.form', $data);
