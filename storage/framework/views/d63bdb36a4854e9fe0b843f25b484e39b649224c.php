      ...
      <div class="form-row">
         ...
         <div class="col-md-6">
           ...
           <select name="country_id" id="country_id" class="form-control select2-single">                                        
               ...
               {
                   ?>
                   <option value="<?php echo e($country->id); ?>" <?php if($country_id == $country->id) echo 'selected'; ?>><?php echo e($country->name); ?></option>
               <?php } ?>
           </select>
       </div>
       <div class="col-md-6">
...
</script><?php /**PATH /var/www/html/makesecurepro/resources/views/admin/states/form.blade.php ENDPATH**/ ?>