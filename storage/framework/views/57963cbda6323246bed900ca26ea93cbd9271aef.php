...
// echo $url;
  ...
  <!-- BEGIN: Main Menu-->
  <div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true" data-img="<?php echo e(url('/assets/antitheft/')); ?>/app-assets/images/backgrounds/02.jpg">
        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation" style="margin-top: 192px;">
          ...
          <li class=" nav-item has-sub"><a href="#"><i class="fas fa-layer-group"></i><span class="menu-title" data-i18n="">Reports</span></a>
              <ul class="menu-content">
                <?php if(CustomHelper::isAllowedModule('reports')): ?>
                <?php if(CustomHelper::isAllowedSection('reports' , 'list')): ?>
                  <li class="<?php if($url == $baseurl.'/'.$ADMIN_ROUTE_NAME.'/'.'generate-excel-report') echo "active"?>"><a class="menu-item" href="<?php echo e($baseurl.'/admin/generate-excel-report-zero'); ?>">Zero Report</a></li>
                <?php endif; ?>
                <?php endif; ?>
                <?php if(CustomHelper::isAllowedModule('reports')): ?>
                <?php if(CustomHelper::isAllowedSection('reports' , 'list')): ?>
                  <li class="<?php if($url == $baseurl.'/'.$ADMIN_ROUTE_NAME.'/'.'user-data-report') echo "active"?>"><a class="menu-item" href="<?php echo e($baseurl.'/admin/user-data-report'); ?>">User Report</a></li>
                <?php endif; ?>
                <?php endif; ?>
                <?php if(CustomHelper::isAllowedModule('reports')): ?>
                <?php if(CustomHelper::isAllowedSection('reports' , 'list')): ?>
                  <li class="<?php if($url == $baseurl.'/'.$ADMIN_ROUTE_NAME.'/'.'coupon-details-report') echo "active"?>"><a class="menu-item" href="<?php echo e($baseurl.'/admin/coupon-details-report'); ?>">Coupon Report</a></li>
                <?php endif; ?>
                <?php endif; ?>
            </ul>
          </li>
    ...
    <!-- END: Main Menu-->
<?php /**PATH D:\after_emilocket_\makesecurepro\resources\views/admin/common/sidebar.blade.php ENDPATH**/ ?>