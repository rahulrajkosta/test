...
<div class="content-body">
 ...
 <?php echo $__env->make('snippets.flash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      <div class="card-content collapse show">
          <div class="card-body">
            <form class="card-body" action="<?php echo e(route('admin.change_password')); ?>" method="post" accept-chartset="UTF-8" enctype="multipart/form-data" role="form">
...
<?php /**PATH /var/www/html/makesecurepro/resources/views/admin/profile/change_password.blade.php ENDPATH**/ ?>