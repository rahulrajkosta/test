        ...
        <div class="col-md-6">
          <div class="card">
           ...
           <h1></h1>
            ...
            <div class="card-block">
              <div class="card-body">
                <form action="<?php echo e(route('admin.temporary_lock_phone')); ?>" method="post">
                  <?php echo csrf_field(); ?>
        ...
        <div class="col-md-6">
          <div class="card">
           ...
           <h1></h1>
            ...
            <div class="card-block">
              <div class="card-body">
                <form action="<?php echo e(route('admin.check_lock_status')); ?>" method="post">
                  <?php echo csrf_field(); ?>
                  <input type="hidden" name="type" value="temp_lock">
                  <div class="form-row">
                    <div class="col-md-12 mb-3">
        ...
        <div class="col-md-6">
          <div class="card">
           ...
           <h1></h1>
            ...
            <div class="card-block">
              <div class="card-body">
                <form action="<?php echo e(route('admin.update_screenshot')); ?>" method="post">
                  <?php echo csrf_field(); ?>
                  <input type="hidden" name="type" value="temp_unlock">
                  <div class="form-row">
                    <div class="col-md-12 mb-3">
...
<?php /**PATH /var/www/html/example-app/resources/views/admin/profile/lock_phone.blade.php ENDPATH**/ ?>