  ...
  <section class="input-validation">
    <div class="row">
      ...
      <div class="card-content collapse show">
          <div class="card-body">
            <form class="card-body" action="<?php echo e(route('admin.notifications.send_users')); ?>" method="post" accept-chartset="UTF-8" enctype="multipart/form-data" role="form">
...
<?php /**PATH /var/www/html/makesecurepro/resources/views/admin/notification/index.blade.php ENDPATH**/ ?>