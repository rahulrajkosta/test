                  ...
                  <?php if(!empty($reports)){
                    ...
                    foreach($reports as $cat){
                      ...
                      <td><?php if(!empty($cat->user_id)){?>
                        ...
                        <?php 
                        if($cat->type == 'role_coupon_allocation'){?>  
                          <!-- <td><a onclick="export_reports_node('<?php echo e($cat->start_date); ?>','<?php echo e($cat->end_date); ?>','<?php echo e($cat->role); ?>','<?php echo e($cat->user_id); ?>','<?php echo e($cat->id); ?>')"><i class="fa fa-refresh"></i></a></td>                -->
                          <td>
                            <?php if($cat->role == 4){?>
                            <a href="https://matrixmyemilocker.com/example-app/reports/tsm_allocation.php?role=<?php echo e($cat->role); ?>&start_date=<?php echo e($cat->start_date??''); ?>&end_date=<?php echo e($cat->end_date??''); ?>&user_id=<?php echo e($cat->user_id ??''); ?>"><i class="fa fa-refresh"></i></a>
                          <?php }if($cat->role == 3){?>
                            <a href="https://matrixmyemilocker.com/example-app/reports/distributor_allocation.php?role=<?php echo e($cat->role); ?>&start_date=<?php echo e($cat->start_date??''); ?>&end_date=<?php echo e($cat->end_date??''); ?>&user_id=<?php echo e($cat->user_id ??''); ?>"><i class="fa fa-refresh"></i></a>
                          <?php }?>
                          </td>
                        <?php }else if($cat->type == 'role_closing_coupon'){?>
                          <td>
                            <a href="https://matrixmyemilocker.com/example-app/reports/role_closing_coupon.php?role=<?php echo e($cat->role); ?>"><i class="fa fa-refresh"></i></a>

                          </td>
                        <?php }else if($cat->type == 'role_info'){?>
                          <td>
                            <a href="https://matrixmyemilocker.com/example-app/reports/role_info.php?role=<?php echo e($cat->role); ?>"><i class="fa fa-refresh"></i></a>
                        ...
                        <?php }else if($cat->type == 'user_export'){?>
                          <td>
                           <a href="https://matrixmyemilocker.com/example-app/reports/user_export.php?start_date=<?php echo e($cat->start_date??''); ?>&end_date=<?php echo e($cat->end_date??''); ?>"><i class="fa fa-refresh"></i></a>

                          </td>

                        <?php  }else if($cat->type == 'zero_touch_report'){?>
                          <td>
                           <a href="https://matrixmyemilocker.com/example-app/reports/zero_touch_report.php?start_date=<?php echo e($cat->start_date??''); ?>&end_date=<?php echo e($cat->end_date??''); ?>"><i class="fa fa-refresh"></i></a>
...
<script type="text/javascript">
  ...
  function role_closing_coupon(role){
    var url = 'https://matrixmyemilocker.com/example-app/reports/role_closing_coupon.php?role='+role+' ';
    $.ajax({
      url: url,
      type: "GET",
      data: {},
...
</script><?php /**PATH /var/www/html/example-app/resources/views/admin/reports/index.blade.php ENDPATH**/ ?>