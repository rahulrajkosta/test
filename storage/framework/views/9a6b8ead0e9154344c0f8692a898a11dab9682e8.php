                                                    ...
                                                    <div class="col-4 mt-3">
                                                        ...
                                                        <div class="input-group">
                                                            <select class="form-control select2"
                                                                name="<?php echo e($role->slug . '_id'); ?>"
                                                                id="role<?php echo e($role->slug); ?>"
                                                                onchange="get_childs(this.value,'<?php echo e($child_role->slug ?? ''); ?>')">
                                            ...
                                            if(in_array($user->id,$superdist_id)){
                                              ?>
                                                                <option value="<?php echo e($user->id); ?>">
                                                                    ...
                                                                    <?php echo e($user->unique_id ?? ''); ?></option>
                                                                <?php }}else{?>
                                                                <option value="<?php echo e($user->id); ?>">
                                                                    <?php echo e($business_name ?? ''); ?> --
                                                                    <?php echo e($user->unique_id ?? ''); ?></option>
                                      ...
                                      $j--;
                                        ...
                                        if(!empty($states)){
                                          foreach($states as $state){?>
                                                            <option value="<?php echo e($state->id ?? ''); ?>" <?php if ($state_id == $state->id) {
                                                                echo 'selected';
                                                            } ?>>
                                        ...
                                        if(!empty($cities)){
                                          foreach($cities as $city){?>
                                                            <option value="<?php echo e($city->id ?? ''); ?>" <?php if ($city_id == $city->id) {
                                                                echo 'selected';
                                                            } ?>>
                                        ...
                                        ?>
                                                    ...
                                                    <div class="col-4 mt-3">
                                                        ...
                                                        <input type="text" name="pincode"
                                                            value="<?php echo e($pincode ?? ''); ?>" class="form-control"
                            ...
                            <div class="table-responsive">
                              ...
                              ?>
                                        <tr>
                                            ...
                                            <td>Name : <?php echo e($user->user_name ?? ''); ?><br>Phone : <?php echo e($user->user_phone ?? ''); ?> <br>Address: <?php echo e($user->address ?? ''); ?>

                                                <!-- <img src="<?php echo e(url('public/storage/user/' . $user->user_image)); ?>" style="height:70px;width:70px"></td> -->

                                                <a target="_blank" href="<?php echo e($image); ?>"><img
                                                        src="<?php echo e($image); ?>" style="height:70px;width:70px"></a>
                                                ...
                                                <p>ScreenShot</p>
                                                <a href="<?php echo e(url('public/storage/screenshot/' . $user->screenshot)); ?>"
                                                    target="_blank"><img
                                                        src="<?php echo e(url('public/storage/screenshot/' . $user->screenshot)); ?>"
                                            ...
                                            <td>
                                                ...
                                                </strong><?php echo e($admin->business_name ?? ''); ?><br><strong>Unique ID
                                                    :</strong> <?php echo e($admin->unique_id ?? ''); ?>

                                                <br><strong>Coupon Code :</strong>
                                                <?php echo e($user->coupon_code ?? ''); ?><br><strong>Used At :
                                                </strong><?php echo e($user->date_of_purchase ?? ''); ?>

                                            </td>
                                            <td width="30%">
                                                <strong>Phone Model :
                                                </strong><?php echo e($user->phone_model ?? ''); ?><br><strong>Mobile Name
                                                    :</strong> <?php echo e($user->mobile_name ?? ''); ?>

                                                <br><strong>IMEI No :</strong>
                                                <?php echo e($user->imei_no ?? ''); ?><br><strong>Date Of Purchase :
                                                </strong><?php echo e($user->date_of_purchase ?? ''); ?>

                                                <br><span style="line-break:anywhere;"><strong>Device Token :
                                                    </strong><?php echo e($user->device_token ?? ''); ?></span>

                                            </td>

                                            <td>
                                                <strong>Total Price :
                                                </strong><?php echo e($user->total_price ?? ''); ?><br><strong>Down Payment
                                                    :</strong> <?php echo e($user->downpayment ?? ''); ?>

                                                <br><strong>Emi :</strong> <?php echo e($user->emi ?? ''); ?><br><strong>Total
                                                    Months : </strong><?php echo e($user->total_months ?? ''); ?><br><strong>Start
                                                    Date : </strong><?php echo e($user->start_date ?? ''); ?>


                                            </td>
                                            <td><strong>Latitute : </strong><?php echo e($user->latitute ?? ''); ?>

                                                <br><strong>Longitude : </strong><?php echo e($user->longitude ?? ''); ?></td>
                                            <td>
                                                <h2><?php echo e(ucfirst($user->phone_status)); ?></h2>
                                                <br>
                                                <br>
                                                <?php if($user->phone_status == 'locked'){?>
                                                <a onclick="change_phone_status('<?php echo e($user->user_id); ?>','unlock')"
                                                    class="btn btn-success">Unlock</a> &nbsp;&nbsp;
                                                <br>
                                                <br>
                                                <a href=""
                                                    onclick="change_phone_status('<?php echo e($user->user_id); ?>','remove')"
                                                    class="btn btn-info">Remove</a> &nbsp;&nbsp;
                                                <?php }?>

                                                <?php if($user->phone_status == 'unlock'){?>
                                                <a onclick="change_phone_status('<?php echo e($user->user_id); ?>','locked')"
...
<?php /**PATH D:\after_emilocket_\makesecurepro\resources\views/admin/user/index.blade.php ENDPATH**/ ?>